    ...
    <section class="text-center bg-light-900 md:(pt-100px pb-135px mt-87px) py-10 mt-10 block">
        <div class="container md:px-10 px-2 mx-auto">
            ...
            >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="chevron-icon text-black -right-1 left-auto sb-intro-next" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                </svg>
                <svg xmlns="http://www.w3.org/2000/svg" class="chevron-icon text-black -left-1 right-auto sb-intro-prev" viewBox="0 0 20 20" fill="currentColor">
